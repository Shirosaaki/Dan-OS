...
// A simple monospace console font covering printable ASCII (32-127)
//
// Each character is 16 rows of 8 pixels. Each row is stored as a single byte
// where bit 7 is the leftmost pixel and bit 0 is the rightmost pixel.
...
const uint8_t font8x16_data[FONT8X16_NUM_CHARS * FONT8X16_HEIGHT] = {
    // Character 32: ' ' (space)
    ...
    // Character 127: DEL (block character for unprintable)
